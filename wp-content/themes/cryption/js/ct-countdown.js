	...
	$(function() {
		$('.countdown-container').each(function() {
			...
			if($glEvent.hasClass('countdown-style-5')){
                ...
                var glNumberWeight = $glEvent.attr('data-weightnumber');
				var	glColorDays = $glEvent.attr('data-colordays');
				var	glColorHours = $glEvent.attr('data-colorhours');
				var	glColorMinutes = $glEvent.attr('data-colorminutes');
				var	glColorSeconds = $glEvent.attr('data-colorseconds');
				var	elCD = countdown_init_circle_time(glEventDate, glStartEventDate)[0];
				var	elCH = countdown_init_circle_time(glEventDate, glStartEventDate)[1];
				var	elCM = countdown_init_circle_time(glEventDate, glStartEventDate)[2];
				var	elCS = countdown_init_circle_time(glEventDate, glStartEventDate)[3];
				var	elAllCD = countdown_init_circle_time(glEventDate, glStartEventDate)[4];
