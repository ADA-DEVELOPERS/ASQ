<!-- <div class="socials-sharing socials socials-colored-hover socials-rounded">
	...
	<a class="socials-item" target="_blank" href="<?php echo esc_url('https://www.pinterest.com/pin/create/button/?url='.urlencode(get_permalink()).'&amp;description='.urlencode(get_the_title())); ?>" title="Pinterest"><i class="socials-item-icon pinterest"></i></a>
